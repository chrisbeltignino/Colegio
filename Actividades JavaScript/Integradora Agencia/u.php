...
<main>
	...
	?>
	<table border="1", id="datos" style="background-color: #F9F9F9">
		<tr>
			<th>ID</th>
			<th>Nombre</th>
			<th>Apellido</th>
...
<center>
	<fieldset style="width: 325px; height: 65px;" border="3">
		<legend>Buscador</legend>
		<label><input id="searchTerm" type="text" onkeyup="doSearch()"></label>
	</fieldset>
</center>
<br>
<br>
